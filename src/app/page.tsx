...
export default async function HomePage({
  ...
  searchParams: Promise<{ code?: string | string[]; view?: string | string[]; date?: string | string[] }>;
}) {
  ...
  const { code, view, date } = await searchParams;
  ...
  return <AdultAdminApp data={toAdultAdminReadModel(dashboard)} initialView={view === "activity" ? "activity" : undefined} />;
}
